...
* PHP 8.4
    * [`8.4.22-lighttpd-1.4.84-trixie`,    `8.4.22-lighttpd-1.4-trixie`,    `8.4.22-lighttpd-trixie`,    `8.4-lighttpd-1.4-trixie`,    `8.4-lighttpd-trixie`,    `8.4.22-lighttpd`,    `8.4-lighttpd-1.4`,    `8.4-lighttpd`   ](./variations/8.4/trixie/Dockerfile) - unprivileged Debian-based image
    * [`8.4.22-lighttpd-1.4.84-s6-trixie`, `8.4.22-lighttpd-1.4-s6-trixie`, `8.4.22-lighttpd-s6-trixie`, `8.4-lighttpd-1.4-s6-trixie`, `8.4-lighttpd-s6-trixie`, `8.4.22-lighttpd-s6`, `8.4-lighttpd-1.4-s6`, `8.4-lighttpd-s6`](./variations/8.4/trixie/s6.dockerfile) - s6-overlay Debian-based image
    * [`8.4.22-lighttpd-1.4.84-alpine`,    `8.4.22-lighttpd-1.4-alpine`,    `8.4.22-lighttpd-alpine`,    `8.4-lighttpd-1.4-alpine`,    `8.4-lighttpd-alpine`   ](./variations/8.4/alpine/Dockerfile) - unprivileged Alpine-based image
    * [`8.4.22-lighttpd-1.4.84-s6-alpine`, `8.4.22-lighttpd-1.4-s6-alpine`, `8.4.22-lighttpd-s6-alpine`, `8.4-lighttpd-1.4-s6-alpine`, `8.4-lighttpd-s6-alpine`](./variations/8.4/alpine/s6.dockerfile) - s6-overlay Alpine-based image
* PHP 8.5
    * [`8.5.7-lighttpd-1.4.84-trixie`,    `8.5.7-lighttpd-1.4-trixie`,    `8.5.7-lighttpd-trixie`,    `8.5-lighttpd-1.4-trixie`,    `8.5-lighttpd-trixie`,    `8-lighttpd-trixie`,    `lighttpd-trixie`,    `8.5.7-lighttpd`,    `8.5-lighttpd-1.4`,    `8.5-lighttpd`,    `8-lighttpd`,    `lighttpd`](./variations/8.5/trixie/Dockerfile) - unprivileged Debian-based image
    ...
    * [`8.5.7-lighttpd-1.4.84-alpine`,    `8.5.7-lighttpd-1.4-alpine`,    `8.5.7-lighttpd-alpine`,    `8.5-lighttpd-1.4-alpine`,    `8.5-lighttpd-alpine`,    `8-lighttpd-alpine`,    `lighttpd-alpine`   ](./variations/8.5/alpine/Dockerfile) - unprivileged Alpine-based image
    * [`8.5.7-lighttpd-1.4.84-s6-alpine`, `8.5.7-lighttpd-1.4-s6-alpine`, `8.5.7-lighttpd-s6-alpine`, `8.5-lighttpd-1.4-s6-alpine`, `8.5-lighttpd-s6-alpine`, `8-lighttpd-s6-alpine`, `lighttpd-s6-alpine`](./variations/8.5/alpine/s6.dockerfile) - s6-overlay Alpine-based image
